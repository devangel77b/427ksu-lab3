...
\end{center}
\caption{Graph showing the force in \unit{\newton} generated at different compression distances in meters. Between \qty{0.03}{\meter} and \qty{0.05}{\meter} shows the popper’s snap-through. The respective elastic potential energies at \qty{0.03}{\meter}, \qty{0.05}{\meter}, and \qty{0.06}{\meter} are shown as areas under the curve.}
\label{fig:3}
\end{figure}
